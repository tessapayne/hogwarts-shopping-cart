...
//decreases the quantity of an item when the minus button is clicked
...
//increases the quantity when the plus button is clicked
...
//calculating subtotal --> adding price * quantity for each item
